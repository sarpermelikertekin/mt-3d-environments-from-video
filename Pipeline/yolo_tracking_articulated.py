...
edges_csv1, objects_csv1 = track_objects_with_yolo(
    video_path_1, model_path_yolo1, output_base_dir, camera_position_1, camera_rotation_1,
    start_angle_1, end_angle_1, forward_rotation_1, file_name_1, "_o", "_f"
)
...
edges_csv2, objects_csv2 = track_objects_with_yolo(
    video_path_2, model_path_yolo1, output_base_dir, camera_position_2, camera_rotation_2,
    start_angle_2, end_angle_2, forward_rotation_2, file_name_2, "_c", "_f"
)

# Merge perspectives for YOLO1
ground_truth_suffix_yolo1 = "gt_yolo1"
merge_perspectives(
    objects_csv1, edges_csv1, objects_csv2, edges_csv2, output_base_dir, ground_truth_suffix_yolo1, threshold=3
)
merged_objects_yolo1 = os.path.join(output_base_dir, ground_truth_suffix_yolo1, f"{ground_truth_suffix_yolo1}_merged_objects.csv")
merged_edges_yolo1 = os.path.join(output_base_dir, ground_truth_suffix_yolo1, f"{ground_truth_suffix_yolo1}_merged_edges.csv")
...
edges_csv3, objects_csv3 = track_objects_with_yolo(
    video_path_3, model_path_yolo2, output_base_dir, camera_position_3, camera_rotation_3,
    start_angle_3, end_angle_3, forward_rotation_3, file_name_3, "_o", "_f"
)
...
edges_csv4, objects_csv4 = track_objects_with_yolo(
    video_path_4, model_path_yolo2, output_base_dir, camera_position_4, camera_rotation_4,
    start_angle_4, end_angle_4, forward_rotation_4, file_name_4, "_c", "_f"
)

# Merge perspectives for YOLO2
ground_truth_suffix_yolo2 = "gt_yolo2"
merge_perspectives(
    objects_csv3, edges_csv3, objects_csv4, edges_csv4, output_base_dir, ground_truth_suffix_yolo2, threshold=3
)
merged_objects_yolo2 = os.path.join(output_base_dir, ground_truth_suffix_yolo2, f"{ground_truth_suffix_yolo2}_merged_objects.csv")
merged_edges_yolo2 = os.path.join(output_base_dir, ground_truth_suffix_yolo2, f"{ground_truth_suffix_yolo2}_merged_edges.csv")

##### Final Merge of All Perspectives #####
final_ground_truth_suffix = "gt_final"
merge_perspectives(
    merged_objects_yolo1, merged_edges_yolo1, merged_objects_yolo2, merged_edges_yolo2,
    output_base_dir, final_ground_truth_suffix, threshold=3
)
